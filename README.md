...
1) Clone the repository with the git command (`git clone https://github.com/yvergit/yverchat`)
2) Get in the newly created folder with the cd command (`cd yverchat`)
...
7) You will see a file named yverchat-1.0-SNAPSHOT.jar or an equivalent, this is the compiled program!
8) Copy this file to its' own folder for running, and run it (`java -jar yverchat-1.0-SNAPSHOT.jar`) (or whatever the .jar file is named)
